document.addEventListener('DOMContentLoaded', function() {
  ...
  if (matchedBanners.length > 0) {
    ...
    promoBanner.innerHTML = '<span>'+mostRecentBanner.message+'</span><button class="close-banner" style="background-color:'+mostRecentBanner.backgroundColor+';color:'+mostRecentBanner.textColor+'">Close</button>';
